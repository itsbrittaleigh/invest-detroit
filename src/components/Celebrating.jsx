    ...
    <div className="wrapper wrapper--flex">
      <div className="col--lt indented">
        ...
        <p className="lead">
          ...
          Detroit. It has been a journey of relationship-building, learning, refining, and expanding our
        ...
        <p className="arial color--gray text--small">
          ...
          we still have our eyes on growth. And with the support of our partners and community over
